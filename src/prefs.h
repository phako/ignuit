...
#define PREF_APP_WIDTH              "app-width"
#define PREF_APP_HEIGHT             "app-height"
#define PREF_CATEGORY_PANE_WIDTH    "category-pane-width"
#define PREF_QUIZ_WIDTH             "quiz-width"
#define PREF_QUIZ_HEIGHT            "quiz-height"
#define PREF_TAGGER_WIDTH           "tagger-width"
#define PREF_TAGGER_HEIGHT          "tagger-height"
#define PREF_CATEGORY_COLUMN_TITLE_WIDTH "category-column-title-width"
#define PREF_CARD_COLUMN_FRONT_WIDTH    "card-column-front-width"
#define PREF_CARD_COLUMN_BACK_WIDTH     "card-column-back-width"
#define PREF_CARD_COLUMN_CATEGORY_WIDTH "card-column-category-width"
#define PREF_CARD_COLUMN_VISIBLE    "card-column-visible"
#define PREF_STICKY_FLIPS           "sticky-flips"
#define PREF_AUTO_LISTEN            "auto-listen"
#define PREF_CARD_FONT              "card-font"
#define PREF_CARD_COLORS            "card-colors"
#define PREF_SCHEDULES              "schedules"
#define PREF_WORKDIR                "workdir"
#define PREF_FIND_WITH_REGEX        "find-with-regex"
#define PREF_CONFIRM_EMPTY_TRASH    "confirm-empty-trash"
#define PREF_MAIN_TOOLBAR_VISIBLE   "main-toolbar-visible"
#define PREF_CATEGORY_PANE_VISIBLE  "category-pane-visible"
#define PREF_BOTTOM_TOOLBAR_VISIBLE "bottom-toolbar-visible"
#define PREF_STATUSBAR_VISIBLE      "statusbar-visible"
#define PREF_QUIZ_ANSWERBAR_VISIBLE "quiz-answerbar-visible"
#define PREF_EDITOR_TAGBAR_VISIBLE  "editor-tagbar-visible"
#define PREF_LATEX_DPI              "latex-dpi"
#define PREF_BACKUP                 "backup"
